...
const getUserNames = users => {
    ...
    users.forEach(element => {
        arrayOfNames += element.name + " , ";
        if (element.name === "Sheree Anthony") {
            arrayOfNames += element.name + "."
        }
    });
    return arrayOfNames;
...
const getUsersWithEyeColor = (users, color) => {
    let arrayDurEyeColor = [];
    users.forEach(element => {
        if (element.eyeColor === color){
            arrayDurEyeColor.push(element);
        }
    });
    return arrayDurEyeColor;
};
...
const getUsersWithGender = (users, gender) => {
    ...
    users.forEach(element => {
        if (element.gender === gender){
            nameByGender.push(element.name);
        }
    });
    return nameByGender;
};
